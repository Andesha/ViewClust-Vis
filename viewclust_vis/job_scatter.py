...
def job_scatter(account, target, d_from,
d_to='', d_from_drop='', out_name='', out_path='',
plot_jobstack=True, plot_insta=True, plot_cumu=True, plot_mem_delta=False, plot_start_wait=False):
    ...
    #job_frame=job_frame[job_frame['state'].str.contains('RUN')]
    ...
    job_frame_pend=job_frame_pend[job_frame_pend['state'].str.match('PENDING')]

    fig_hist = px.histogram(job_frame_pend,
                    y='priority',
                    color="partition")
    fig_hist.write_html(safe_folder + account + out_name + 'pend_histogram_y.html')
    ...
    fig_hist = px.histogram(job_frame_run,
                    y='priority',
                    color="partition")
    fig_hist.write_html(safe_folder + account + out_name + 'run_histogram_y.html')
